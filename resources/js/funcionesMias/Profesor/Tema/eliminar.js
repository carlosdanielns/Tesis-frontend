const asiganturaDelete = JSON.parse(localStorage.getItem("a"));
...
function eliminarCorrecto() {
  ...
  fetch(urlAsignaturaDescripcion + asiganturaDelete, {
    method: "get",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json, text/plain, */*",
        ...
        .then((resGetById) => {
          if (resGetById.niveles.length == 0) {
            ...
            fetch(urlTema + id, {
              ...
              .then((resDeleteTema) => {
                fetch(urlAsignatura + resGetByDescripcion._id + "/tema/" + id, {
                  method: "delete",
                  headers: {
                    "Content-Type": "application/json",
                    Accept: "application/json, text/plain, */*",
            ...
            for (let i = 0; i < resGetById.niveles.length; i++) {
              if (resGetById.niveles[i].preguntas.length != 0) {
                for (
                  ...
                  fetch(urlPregunta + resGetById.niveles[i].preguntas[j]._id, {
                    method: "delete",
                    headers: {
                      "Content-Type": "application/json",
                      Accept: "application/json, text/plain, */*",
              ...
              fetch(urlNivel + resGetById.niveles[i]._id, {
                ...
                .then((resDeleteNivel) => {
                  fetch(urlTema + id + "/nivel/" + resGetById.niveles[i]._id, {
                    method: "delete",
                    headers: {
                      "Content-Type": "application/json",
                      Accept: "application/json, text/plain, */*",
